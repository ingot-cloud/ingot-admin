...
const createKeyStore = (): KeyStore =>
  new KeyStore({
    ...
    storageKey: `${getAdminRuntimeConfig().storage.storePrefix}:crypto:public-key`,
  });
 ...
 */
export let keyStore = createKeyStore();

export const rebindKeyStore = (): void => {
