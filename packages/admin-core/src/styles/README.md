...
| `--in-font-family` | `LarkHackSafariFont, …, PingFang SC, Microsoft Yahei, …` |
...
| `--in-menu-item-height` / `--in-menu-icon-size` / `--in-menu-arrow-size` / `--in-menu-icon-gap` | `40px` / `20px` / `14px` / `8px` |
| `--in-menu-nested-indent` / `--in-menu-text-plain-color` / `--in-menu-text-active-color` | `2em` / `#000000` / `#1f2329` |
...
| `--in-biz-tabs-font-size` / `--in-biz-tabs-ink-height` | `16px` / `3px` |
