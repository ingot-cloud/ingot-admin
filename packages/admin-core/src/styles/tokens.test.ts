...
const REQUIRED_VALUES: Record<string, string> = {
  ...
  "--in-avatar-size": "32px",
  "--in-avatar-size-lg": "48px",
  "--in-biz-tabs-font-size": "var(--in-font-size-section-title)",
  "--in-biz-tabs-color": "var(--in-text-color)",
  "--in-biz-tabs-color-active": "var(--in-color-primary)",
  "--in-biz-tabs-ink-height": "3px",
  "--in-drawer-width-detail": "480px",
  "--in-motion-ease-tabs-ink": "cubic-bezier(0.34, 0.69, 0.1, 1)",
  ...
  "--in-message-min-width": "204px",
  "--in-message-height": "54px",
  "--in-message-icon-size": "20px",
  ...
  "--in-menu-arrow-size": "14px",
  "--in-menu-icon-gap": "var(--in-space-2)",
  "--in-menu-base-level-padding": "16px",
  "--in-menu-nested-indent": "2em",
  "--in-menu-text-color": "var(--in-text-color-secondary)",
  "--in-menu-text-plain-color": "var(--in-black)",
  "--in-menu-text-active-color": "var(--in-gray-950)",
