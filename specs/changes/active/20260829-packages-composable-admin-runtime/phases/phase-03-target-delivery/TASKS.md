...
- [ ] 实现 `pnpm pack` 隔离消费 fixture/脚本，验证 ESM、d.ts、CSS、peer 单实例及发布 manifest 无 `catalog:`/`workspace:`
...
- [ ] 隔离工程使用 TypeScript 6 与 Vite 8 完成验证，workspace catalog 升级后能够同步校验 peer ranges
