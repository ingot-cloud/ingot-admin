...
import { TreeKeyAndProps, type MemberPermissionTreeNodeVO } from "@base/models";
import { BindAuthorityAPI } from "@base/api/platform/member/role";
import { GetAuthorityTreeAPI } from "@base/api/platform/member/permission";
