...
<script lang="ts">
import type { MemberPermission as P } from "@base/models";
export interface API {
  show(data?: P | string): void;
}
</script>
<script lang="ts" setup>
import type { MemberPermission } from "@base/models";
import { TreeKeyAndProps } from "@base/models";
import { useOrgTypeEnums } from "@base/models/enums";
...
import {
  ...
  UpdateAuthorityAPI,
  RemoveAuthorityAPI,
} from "@base/api/platform/member/permission";
...
const defaultEditForm: MemberPermission = {
  id: undefined,
  pid: undefined,
  name: undefined,
  code: undefined,
...
defineExpose({
  show(data?: MemberPermission | string) {
    visible.value = true;
