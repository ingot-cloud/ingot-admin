...
import type { MemberPermission, MemberPermissionTreeNodeVO } from "@base/models";
import { useAuthorityTypeEnums } from "@base/models/enums";
import EditDrawer from "./EditDrawer.vue";
import type { TableAPI } from "@ingot/admin-core";
import { GetAuthorityTreeAPI, UpdateAuthorityAPI } from "@base/api/platform/member/permission";
