import type { SessionConcurrencyPolicy } from "@base/models";
import { SessionConcurrencyScopeEnum } from "@base/models/enums";
import {
  GetConcurrencyPoliciesAPI,
  DeleteConcurrencyPolicyAPI,
} from "@base/api/platform/security/concurrencyPolicy";
