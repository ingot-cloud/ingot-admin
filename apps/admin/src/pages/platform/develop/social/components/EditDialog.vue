...
<script lang="ts">
import type { SysSocialDetails as P } from "@base/models";
export interface API {
  show(data?: P): void;
}
</script>
<script lang="ts" setup>
import type { SysSocialDetails } from "@base/models";
...
import { CreateSocialAPI, UpdateSocialAPI } from "@base/api/platform/dev/social";
