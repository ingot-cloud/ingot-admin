...
<script lang="ts">
import type { PlatformDict as DictRecord } from "@base/models";
import type { DictScope as DictScopeType } from "@base/models/enums";
...
import type { Page, PlatformDict, ApplicationPageItemVO } from "@base/models";
import type { LoadDataParams } from "@ingot/admin-core";
import { CommonStatus, DictType, DictScope } from "@base/models/enums";
import { CreateDictAPI, UpdateDictAPI, RemoveDictAPI } from "@base/api/platform/config/dict";
import { GetAppPageAPI } from "@base/api/platform/config/app";
import { Message } from "@ingot/admin-core";
import { copyParams, getDiff } from "@ingot/admin-core";
import TenantSelect from "@base/components/biz/TenantSelect.vue";
