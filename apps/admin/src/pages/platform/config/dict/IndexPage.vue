...
import { GetDictPageAPI, ChangeDictStatusAPI, RemoveDictAPI } from "@base/api/platform/config/dict.ts";
import { GetAppPageAPI } from "@base/api/platform/config/app.ts";
