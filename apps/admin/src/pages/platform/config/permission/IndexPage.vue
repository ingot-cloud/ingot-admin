...
import type { PlatformPermission, PermissionTreeNode } from "@base/models";
import { useOrgTypeEnums, useAuthorityTypeEnums } from "@base/models/enums";
import type { TableAPI } from "@ingot/admin-core";
import { GetAuthorityTreeAPI } from "@base/api/platform/config/authority.ts";
