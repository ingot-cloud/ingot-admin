...
<script lang="ts">
import type { PlatformPermission as P } from "@/models";
...
import {
  ...
  UpdateAuthorityAPI,
  RemoveAuthorityAPI,
} from "@/api/platform/base/authority";
...
const defaultEditForm: PlatformPermission = {
  id: undefined,
  pid: undefined,
  name: undefined,
  code: undefined,
...
defineExpose({
  show(data?: PlatformPermission | string) {
    visible.value = true;
