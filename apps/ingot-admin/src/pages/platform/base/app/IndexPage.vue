...
import type { MenuTreeNode, PlatformApp } from "@/models";
import { OrgTypeEnums } from "@/models/enums";
import EditDrawer from "./EditDrawer.vue";
import type { TableAPI } from "@/components/table";
import { GetMenuTreeAPI } from "@/api/platform/base/menu";
import { GetAppPageAPI, UpdateAppAPI, RemoveAppAPI } from "@/api/platform/base/app";
...
const handleRemove = (params: PlatformApp) => {
