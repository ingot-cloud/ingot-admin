...
import type { MetaMenu } from "@/models";
...
const defaultEditForm: MetaMenu = {
  id: undefined,
  pid: undefined,
  name: undefined,
...
const privateOnConfirmClick = () => {
  ...
  form.validate((valid: boolean) => {
    if (valid) {
      ...
      if (edit.value) {
        const params = getDiff<MetaMenu>(rawForm, editForm);
